...
public interface DistributedLockManager {
   ...
   * @return true if locked
   * @throws InterruptedException if current thread is interrupted acquiring
   *           lock
   */
   ...
   *
   * @param key the name of the lock
   * @return true if the lock exists and was created by this manager. The lock
   *         may not have been created by the calling thread.
   */
  boolean isLocked(String key);

  /**
   * force unlock of the distributed locks created by this
